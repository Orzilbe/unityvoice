...
export default function Topics() {
  ...
  const topics = [
    { id: 1, en: 'History and Heritage', he: 'הסטוריה ומורשת', link: '/topics/history-and-heritage/words', icon: '🏛️' },
  ...
  // Define whether the user is on the edit profile page
  const isEditPage = true; // Set this flag to `true` only on the page where editing is allowed
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50 p-6 relative">
      ...
      <div className="absolute top-4 right-4">
        <UserProfile 
          ...
          isEditingAllowed={isEditPage} // Pass the edit permission flag
        />
      </div>
