...
export default function Flashcards() {
  ...
  const flashcards: Flashcard[] = [
    ...
    { id: 1, word: 'Battlefield', translation: 'שְׂדֵה קְרָב', example: 'The battlefield was covered with smoke.', difficulty: 'easy' },
    { id: 2, word: 'Commander', translation: 'מְפַקֵּד', example: 'The commander gave clear instructions to the soldiers.', difficulty: 'easy' },
