  ...
  const quizQuestions = [
    {
      id: 0,
      word: 'Ancient',
      options: ['עַתִיק', 'חָדָשׁ', 'יָשָׁן', 'מוֹדֶרְנִי'],
      correctAnswer: 'עַתִיק',
    },
    {
      id: 1,
      word: 'Historical',
      options: ['הִיסטוֹרִי', 'עָתִיד', 'אַגָּדִי', 'דִּמְיוֹנִי'],
      correctAnswer: 'הִיסטוֹרִי',
    },
    {
      id: 2,
      word: 'Monument',
      options: ['אַנְדַּרְטָה', 'בַּיִת', 'פַּרְק', 'שׁוּרָה'],
      correctAnswer: 'אַנְדַּרְטָה',
    },
    {
      id: 3,
      word: 'Preserve',
      options: ['לְשַׁמֵּר', 'לְהַרוֹס', 'לְשַׁנוֹת', 'לְהַעֲלִים'],
      correctAnswer: 'לְשַׁמֵּר',
    },
    {
      id: 4,
      word: 'Tradition',
      options: ['מָסוֹרֶת', 'חִדּוּשׁ', 'שִׁנּוּי', 'סְטִיָה'],
      correctAnswer: 'מָסוֹרֶת',
    },
  ];
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center p-4 z-50">
          <div className="bg-white p-10 rounded-2xl shadow-2xl max-w-md w-full">
            ...
            <div className="space-y-4">
              ...
              <button
                onClick={() => router.push('/topics/history-and-heritage/post')}
